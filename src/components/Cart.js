            ...
            <div className="p-6 mb-8 border bg-gray-50 dark:bg-gray-800 dark:border-gray-800">
              ...
              <div className="py-4 mb-8 border-t border-b border-gray-200 dark:border-gray-700">
                <div className="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
                  ...
                  <div className="hidden px-4 lg:block lg:w-2/12">
                    <p className="text-lg font-bold text-indigo-500 dark:text-gray-400">
                      $100.00
                    </p>
              ...
              <div className="w-full px-4 mb-4 lg:w-1/2 ">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <input
                    ...
                    required
                  />
                  <button className="inline-block w-full px-8 py-4 font-bold text-center text-gray-100 bg-indigo-500 rounded-md lg:w-32 hover:bg-indigo-600">
                    Apply
                  </button>
                </div>
              </div>
              <div className="w-full px-4 mb-4 lg:w-1/2 ">
                <div className="p-6 border border-indigo-100 dark:bg-gray-900 dark:border-gray-900 bg-gray-50 md:p-8">
