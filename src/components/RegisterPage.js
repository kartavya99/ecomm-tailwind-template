                ...
                <div className="flex flex-wrap items-center -mx-4">
                  ...
                  <div className="w-full px-4 lg:w-2/5">
                    <div className="p-6 shadow-md lg:p-9 bg-gray-50 dark:bg-gray-900 ">
                      <h2 className="mb-4 text-xl uppercase lg:mb-8 lg:text-3xl dark:text-gray-400/70 ">
                        register
                      </h2>
                      <form action="" className="p-0 m-0">
                        ...
                        <div className="mt-5 text-right">
                          <Link
                            href="#"
                            className="text-sm font-semibold text-indigo-700 dark:text-indigo-300 dark:hover:text-indigo-500"
                          >
                            forgot password?
                          </Link>
                        </div>
                        <button
                          className="w-full px-4 py-3 mt-5 font-semibold text-gray-200 bg-indigo-500 rounded-lg dark:bg-indigo-500 hover:text-blue-200 "
                          type="submit"
                        >
                          Create Account
                        </button>
                        <div className="flex flex-wrap items-center mt-3 text-sm text-gray-700 lg:text-base lg:mt-5 dark:text-gray-400">
                          ...
                          <Link
                            to="/login"
                            className="ml-2 text-base font-semibold text-indigo-700 dark:text-indigo-300 dark:hover:text-indigo-500"
                          >
                            Sign In
                          </Link>
                        </div>
