              ...
              <div className="flex flex-wrap ">
                <div className="w-full py-6 bg-gray-100 shadow-md lg:py-7 lg:w-1/2 dark:bg-gray-900">
                  <div className="max-w-md mx-auto">
                    <div className="px-4 my-7 ">
                      <div className="mb-7">
                        <span className="flex items-center justify-center w-20 h-20 mx-auto text-gray-900 bg-indigo-600 rounded-lg dark:bg-indigo-600 ">
                          <svg
                      ...
                      <form action="" className="">
                        ...
                        <div className="mb-4 text-right ">
                          <Link
                            href="/"
                            className="text-sm font-semibold text-sky-500 dark:text-sky-400 dark:hover:text-sky-300 hover:underline"
                          >
                            forgot password?
                          </Link>
                        </div>
                        ...
                        <button
                          className="w-full py-4 mb-4 font-semibold text-gray-200 bg-indigo-600 rounded-lg px-7 dark:text-gray-300 dark:bg-indigo-600 hover:text-sky-200 "
                          type="submit"
                        >
                          LOGIN
                        </button>
                        <p className="text-sm text-gray-700 dark:text-gray-400">
                          ...
                          <Link
                            to="/register"
                            className="text-sm font-semibold text-sky-500 hover:text-sky-600 dark:text-sky-400 dark:hover:text-sky-500"
                          >
                            Create an account
                          </Link>
                        </p>
                ...
                <div className="relative items-center justify-center hidden w-full lg:flex lg:w-1/2 ">
                  ...
                  <div className="top-0 z-10 max-w-xl mx-auto mb-12 text-center ">
                    ...
                    <Link
                      href="/"
                      className="inline-block px-6 py-2 font-medium bg-indigo-600 text-gray-50 dark:text-gray-300"
                    >
                      Join now
                    </Link>
                  </div>
