...
import IconProductPage from "./IconProductPage";
import Nav from "./Nav";
            ...
            <div className="flex flex-wrap mb-24 -mx-4">
                ...
                <div className="sticky top-0 overflow-hidden ">
                  <div className="relative mb-6 lg:mb-10 lg:h-96">
                    ...
                    >
                      <svg
                        ...
                        height={16}
                        fill="currentColor"
                        className="w-5 h-5 text-indigo-500 bi bi-chevron-right dark:text-indigo-200"
                        viewBox="0 0 16 16"
                      >
                        <path
                          fillRule="evenodd"
                  ...
                  <div className="flex-wrap hidden -mx-2 md:flex">
                    <div className="w-1/2 p-2 sm:w-1/4">
                      <a
                        className="block border border-gray-200 hover:border-indigo-400 dark:border-gray-700 dark:hover:border-indigo-300"
                        href="#"
                      >
                        <img
              ...
              <div className="w-full px-4 md:w-1/2">
                <div className="lg:pl-20">
                  <div className="mb-6 ">
                    <span className="px-2.5 py-0.5 text-xs text-indigo-600 bg-indigo-100 dark:bg-gray-700 rounded-xl dark:text-gray-200">
                      New Arrival
                    </span>
                  ...
                  <div className="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p className="mt-2 text-sm text-indigo-500 dark:text-blue-200">
                      Ships from warehouse
                      <span className="text-gray-600 dark:text-gray-400 p-2">
